...
package gov.fbi.partner.investigation;

public class nonPoliceCaliforniaCode{

	//https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?sectionNum=646.9&lawCode=PEN
	public String Stalking(String description){
		return "§646.9 Stalking" + description;
	}

	public boolean  nonPoliceProcess(String uuid, String name){
